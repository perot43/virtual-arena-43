...
if(!cols.includes('billing_first_name'))db.exec(`ALTER TABLE bookings ADD COLUMN billing_first_name TEXT`);
if(!cols.includes('billing_last_name'))db.exec(`ALTER TABLE bookings ADD COLUMN billing_last_name TEXT`);
if(!cols.includes('billing_address'))db.exec(`ALTER TABLE bookings ADD COLUMN billing_address TEXT`);
if(!cols.includes('billing_tax_code'))db.exec(`ALTER TABLE bookings ADD COLUMN billing_tax_code TEXT`);
